...
// Automatisch de database vullen als deze nog leeg is (Gecorrigeerde Full-stack versie)
db.get("SELECT COUNT(*) as count FROM facts", [], (err, row) => {
  if (!err && row.count === 0) {
    ...
    const initialFacts = [
      {
        ...
        source: "https://www.historic-uk.com/HistoryUK/HistoryofBritain/The-Shortest-War-in-History/",
        category: "history",
        votesInteresting: 15,
        votesMindblowing: 8,
        votesFalse: 2
      },
      {
        ...
        source: "https://www.autodesk.com/products/fusion-360/blog/a-look-back-at-the-first-built-in-hard-drive/",
        category: "history",
        votesInteresting: 4,
        votesMindblowing: 1,
        votesFalse: 0
    ...
    // GECORRIGEERDE QUERY: Nu nemen we alle kolommen en 6 vraagtekens ( id en created_at gaan automatisch)
    ...
    stmt.finalize();
    console.log("Standaard data succesvol toegevoegd met stemmen!");
  }
});
